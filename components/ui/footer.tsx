        ...
        <div className="grid grid-cols-2 justify-between gap-12 py-8 sm:grid-rows-[auto_auto] md:grid-cols-4 md:grid-rows-[auto_auto] md:py-12 lg:grid-cols-[repeat(4,minmax(0,180px))_1fr] lg:grid-rows-1 xl:gap-20">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a className="text-indigo-200/65 transition hover:text-indigo-400" href="/servizi/agenti-ia">
                  Agenti IA su Misura
                </a>
              </li>
              <li>
                <a className="text-indigo-200/65 transition hover:text-indigo-400" href="/servizi/data-mining">
                  Ricerca Lead & Data Mining Automatico
                </a>
              </li>
              <li>
                <a className="text-indigo-200/65 transition hover:text-indigo-400" href="/servizi/qualificazione-lead">
                  Qualificazione Lead & Follow-Up H24
                </a>
              </li>
              <li>
                <a className="text-indigo-200/65 transition hover:text-indigo-400" href="/servizi/sincronizzazione-crm">
