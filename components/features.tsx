      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
              ...
              <div className="w-1/3 h-full bg-gray-900/40 border border-gray-800/50 rounded-xl p-4 flex flex-col justify-between transition-all duration-500 group-hover:border-purple-500/20">
                ...
                <div className="space-y-1.5">
                  <div className="w-full h-2 bg-indigo-500/20 rounded-xs overflow-hidden">
                    <div className="w-3/4 h-full bg-indigo-500 animate-[pulse_3s_infinite]"></div>
                  </div>
                ...
                <div className="bg-black/40 p-2 rounded-lg border border-gray-900 text-center text-[11px] text-purple-300 font-medium">
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            {/* CARATTERISTICA 1 */}
            <article className="transition-all duration-300 hover:translate-y-[-4px]">
