...
export default function Features() {
  return (
    <section className="relative bg-black overflow-hidden">
      ...
      {/* --- INIEZIONE CORE ANIMAZIONI AVANZATE --- */}
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .card-radar-effect::before {
          ...
          width: 150%;
          height: 150%;
          background: conic-gradient(from 0deg, transparent 40%, var(--color-indigo-500) 70%, transparent 100%);
          opacity: 0;
        ...
        .card-content-layer {
          position: relative;
          z-index: 10;
          background: rgba(9, 9, 11, 0.85); /* Forza copertura bg */
          height: 100%;
          width: 100%;
        }
      `}} />
        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="flex justify-center pb-12 md:pb-16" data-aos="fade-up">
            <div className="w-full max-w-[900px] h-auto md:h-64 rounded-2xl border border-gray-800/60 bg-gray-950/40 backdrop-blur-xs relative flex flex-col md:flex-row items-center justify-between p-6 md:p-8 overflow-hidden group gap-6 md:gap-0 shadow-[0_0_50px_rgba(99,102,241,0.05)]">
              ...
              <div className="w-full md:w-1/3 h-auto md:h-full bg-gray-900/40 border border-gray-800/50 rounded-xl p-4 flex flex-col justify-between gap-4 md:gap-0 transition-all duration-500 group-hover:border-indigo-500/20 group-hover:bg-indigo-950/5">
                ...
                <div className="space-y-2">
                  <div 
                    className="flex items-center justify-between bg-black/40 p-2 rounded-lg border border-gray-900 gap-2 transition-all duration-300 group-hover:translate-x-1"
              ...
              <div className="flex-1 flex md:flex-row flex-col items-center justify-center relative h-12 md:h-full w-px md:w-full">
                ...
                <div 
                  className="absolute w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center shadow-[0_0_30px_rgba(99,102,241,0.3)] z-10"
              ...
              <div className="w-full md:w-1/3 h-auto md:h-full bg-gray-900/40 border border-gray-800/50 rounded-xl p-4 flex flex-col justify-between gap-4 md:gap-0 transition-all duration-500 group-hover:border-purple-500/20 group-hover:bg-purple-950/5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="text-[11px] text-indigo-200/50 flex justify-between font-mono">
                    ...
                    <span className="text-purple-400 font-bold">100% OK</span>
                  </div>
                </div>
                <div className="bg-black/40 p-2 rounded-lg border border-gray-900 text-center text-[11px] text-purple-300 font-medium transition-all group-hover:scale-[1.02] duration-300">
          ...
          <div className="mx-auto grid max-w-sm gap-6 sm:max-w-none sm:grid-cols-2 md:gap-6 lg:grid-cols-3">
            ...
            <article className="card-radar-effect p-[1px] rounded-xl border border-gray-800/60 bg-gray-950/30 transition-all duration-300 hover:translate-y-[-4px] hover:shadow-[0_10px_30px_rgba(99,102,241,0.08)] group">
              <div className="card-content-layer p-6 rounded-xl flex flex-col h-full">
                ...
                <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200 transition-colors group-hover:text-indigo-400">
