    ...
    <main className="relative bg-[#02040a] text-gray-300 min-h-screen overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-6 py-24 lg:py-32">
        ...
        <div className="mb-16 text-base leading-relaxed text-indigo-100/70">
          <p>
            In Nexify non crediamo nelle soluzioni standardizzate. Ogni azienda ha i suoi colli di bottiglia, i suoi software e le sue abitudini. Il nostro metodo scientifico è progettato per mappare l'esistente, eliminare il lavoro superfluo e integrare sistemi intelligenti senza stravolgere la tua operatività.
          </p>
        </div>

        {/* I 4 Step del Metodo Fluttuanti */}
        <div className="space-y-8">
          
          {/* Step 1 */}
          <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-indigo-500/40 hover:shadow-[0_0_20px_rgba(79,70,229,0.1)] [animation:gentleFloat_4.2s_ease-in-out_infinite]">
          ...
          {/* Step 2 */}
          <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-indigo-500/40 hover:shadow-[0_0_20px_rgba(79,70,229,0.1)] [animation:gentleFloat_4.6s_ease-in-out_infinite] [animation-delay:0.3s]">
            <div className="flex items-start gap-4">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-indigo-500/10 text-sm font-bold text-indigo-400 border border-indigo-500/20">
                02
              </span>
          ...
          {/* Step 3 */}
          <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-indigo-500/40 hover:shadow-[0_0_20px_rgba(79,70,229,0.1)] [animation:gentleFloat_5s_ease-in-out_infinite] [animation-delay:0.6s]">
            <div className="flex items-start gap-4">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-indigo-500/10 text-sm font-bold text-indigo-400 border border-indigo-500/20">
                03
              </span>
          ...
          {/* Step 4 */}
          <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-indigo-500/40 hover:shadow-[0_0_20px_rgba(79,70,229,0.1)] [animation:gentleFloat_5.4s_ease-in-out_infinite] [animation-delay:0.9s]">
            <div className="flex items-start gap-4">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-indigo-500/10 text-sm font-bold text-indigo-400 border border-indigo-500/20">
                04
              </span>
